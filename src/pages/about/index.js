  ...
  render() {
    return (
      <Container className="About-header" fluid={true}>
        <Helmet>
          <meta charSet="utf-8" />
          <title>About | Nam Dong</title>
          <link rel="canonical" href="http://motasimfoad.com/about" />
          <meta
            name="description"
            content="Nam Dong | About - Minimalism | Frontend Developer | Software Engineer with a demonstrated history of working in computer software industry. 
